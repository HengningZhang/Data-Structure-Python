...
class LinkedBinaryTree:
    ...
    def iterative_inorder(self):
        ...
        while current is not None:
            if previous is None or previous.left == current or previous.right == current:
            ...
            current = thenext
def main():
    e = LinkedBinaryTree.Node(5)
    f = LinkedBinaryTree.Node(1)
    g = LinkedBinaryTree.Node(8)
    h = LinkedBinaryTree.Node(4)
    d = LinkedBinaryTree.Node(9,e,f)
    a = LinkedBinaryTree.Node(2,d)
    b = LinkedBinaryTree.Node(7, g, h)
    c = LinkedBinaryTree.Node(3, a, b)
    j = LinkedBinaryTree.Node(5)
    
    tree=LinkedBinaryTree(c)

    for i in tree.iterative_inorder():
        print(i)
